  ...
  <div>
    <NuxtLayout name="default">
      <template #layout-content>
        ...
        <LayoutRow content-max-width="max">
          <template #content>
            <div>
...
import SimpleGrid from "@/components/scaffolding/simple-grid/SimpleGrid.vue";
import SimpleGridItem from "@/components/scaffolding/simple-grid/SimpleGridItem.vue";
import LayoutRow from "@/components/scaffolding/layout-row/LayoutRow.vue";
import FlexGroup from "@/components/scaffolding/flex-group/FlexGroup.vue";
import FlexGroupItem from "@/components/scaffolding/flex-group/FlexGroupItem.vue";
