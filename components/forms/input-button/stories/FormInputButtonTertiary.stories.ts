...
export default {
  title: "Components/Forms/Buttons/Tertiary",
  component: StoryBookComponent,
  args: {
    size: "small", // ["small", "normal", "medium", "large"]
    type: "button",
    variant: "tertiary", // ["primary", "secondary", "tertiary", "text", "link", "ghost", "cancel", "confirm", "warning"]
...
BtnSmall.args = {
  size: "small",
  buttonText: "Tertiary Button Small"
};

export const BtnNormal = Template.bind({});
BtnNormal.args = {
  size: "normal",
  buttonText: "Tertiary Button Normal"
};

export const BtnMedium = Template.bind({});
BtnMedium.args = {
  size: "medium",
  buttonText: "Tertiary Button Medium"
};

export const BtnLarge = Template.bind({});
BtnLarge.args = {
  size: "large",
  buttonText: "Tertiary Button Large"
};
