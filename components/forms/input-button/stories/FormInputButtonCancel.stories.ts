...
export default {
  title: "Components/Forms/Buttons/Cancel",
  component: StoryBookComponent,
  args: {
    size: "small", // ["small", "normal", "medium", "large"]
    type: "button",
    variant: "cancel", // ["primary", "secondary", "tertiary", "text", "link", "ghost", "cancel", "confirm", "warning"]
...
BtnSmall.args = {
  size: "small",
  buttonText: "Cancel Button Small"
};

export const BtnNormal = Template.bind({});
BtnNormal.args = {
  size: "normal",
  buttonText: "Cancel Button Normal"
};

export const BtnMedium = Template.bind({});
BtnMedium.args = {
  size: "medium",
  buttonText: "Cancel Button Medium"
};

export const BtnLarge = Template.bind({});
BtnLarge.args = {
  size: "large",
  buttonText: "Cancel Button Large"
};
