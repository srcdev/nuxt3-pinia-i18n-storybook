...
export default {
  title: "Components/Forms/Buttons/Primary",
  component: StoryBookComponent,
  args: {
    size: "small", // ["small", "normal", "medium", "large"]
    type: "button",
    variant: "primary", // ["primary", "secondary", "tertiary", "text", "link", "ghost", "cancel", "confirm", "warning"]
...
BtnSmall.args = {
  size: "small",
  buttonText: "Primary Button Small"
};

export const BtnNormal = Template.bind({});
BtnNormal.args = {
  size: "normal",
  buttonText: "Primary Button Normal",
  variant: "primary"
};
...
BtnMedium.args = {
  size: "medium",
  buttonText: "Primary Button Medium"
};

export const BtnLarge = Template.bind({});
BtnLarge.args = {
  size: "large",
  buttonText: "Primary Button Large"
};
