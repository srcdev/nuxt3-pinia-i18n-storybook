...
export const maxDesktopWidth = Template.bind({});
maxDesktopWidth.args = {
...
export const maxViewportWidth = Template.bind({});
maxViewportWidth.args = {
  contentMaxWidth: "viewport",
  paddingX: 12,
  paddingY: 0,
  bgColour: "grey",
};
