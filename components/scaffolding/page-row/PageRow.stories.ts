...
DefaultWithoutGutters.args = {
  ...
  default: `
    <div style="background-color: lightgray">
      <div>
        <h2 class="text-body-h1">Default Without Gutters</h2>
...
DefaultWithGutters.args = {
  ...
  default: `
    <div style="background-color: lightgray">
      <div>
        <h2 class="text-body-h1">Default With Gutters</h2>
...
FitContentWithoutGutters.args = {
  ...
  default: `
    <div style="background-color: lightgray">
      <div>
        <h2 class="text-body-h1">Fit Content Without Gutters</h2>
...
FitContentWithGutters.args = {
  ...
  default: `
    <div style="background-color: lightgray">
      <div>
      <h2 class="text-body-h1">Fit Content With Gutters</h2>
